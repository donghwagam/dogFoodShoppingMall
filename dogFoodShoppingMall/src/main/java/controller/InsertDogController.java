...
public class InsertDogController extends HttpServlet {
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String[] allergy = request.getParameterValues("allergy"); // 알러지 번호 // 여러개라서 배열로 선언
      ...
      this.dogDao.insertDog(memberDog, allergy); // 강아지등록 메서드 실행
      
      // response.sendRedirect(request.getContextPath()+"/memberOneController"); // 강아지등록 성공 후 메인페이지로 이동
