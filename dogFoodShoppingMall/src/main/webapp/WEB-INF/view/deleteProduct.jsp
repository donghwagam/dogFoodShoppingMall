		...
		<div class="span5">
            <table class="table table-striped table-condensed">
             <c:forEach var="p" items="${list}">
                  ...
                  <tr>
                    <td>
                    	<form method="post" action="${pageContext.request.contextPath}/deleteProductController">
                    		 <input type="text" value="${p.productId}" name = "productId" hidden="hidden"> 
           				  	 <input type="text" value="${p.photoName}" name = "photoName"hidden="hidden">
                   		 	<button type="submit"><span class="label label-danger">상품삭제</span></button>
                   		</form> 
                    </td>
