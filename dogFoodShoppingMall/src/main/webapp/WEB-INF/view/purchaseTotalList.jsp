...
<nav class="navbar navbar-default navbar-static-top">
	...
	<div class="side-menu">
 	...
 	<form method="get" action="${pageContext.request.contextPath}/purchaseTotalListController?memberId=${memberId}&status=${status}&aDate=${aDate}&bDate=${bDate}">
 	<div>
            ...
            <table class="table table-striped table-condensed">
              ...
              <c:forEach var="p" items="${list}">
                <tr>
                    ...
                    <td>${p.createDate}</td>
                    <td><a href="${pageContext.request.contextPath}/purchaseTotalListController?"></a></td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
