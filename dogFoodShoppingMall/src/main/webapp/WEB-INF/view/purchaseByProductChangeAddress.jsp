				...
				<div class="col-lg-6">
					<nav class="header__menu">
						<ul>
							...
							<li><a href="${pageContext.request.contextPath}/mainPageController">브랜드</a></li>
						</ul>
					</nav>
				</div>
				<div class="col-lg-3">
		    		...
		    		<div class="row">
		    			<div class="col-xs-12">
		    				<address>
			    				...
			    				<br><br>
			    				<form method="post" action="${pageContext.request.contextPath}/searchAddressController?productId=${productId}&msg=purchaseByProductChangeAddr&photoName=${photoName}&productName=${productName}&quantity=${quantity}&totalPriceByProduct=${totalPriceByProduct}">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="footer__about">
						<div class="footer__about__logo">
							<a href="${pageContext.request.contextPath}/mainPageController"><img src="${pageContext.request.contextPath}/Resources/img/dogFoot.png"
								alt=""></a>
						</div>
						<ul>
