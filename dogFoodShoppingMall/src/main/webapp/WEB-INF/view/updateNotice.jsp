	...
	<section class="hero">
		<div class="container">
			<div class="row">
				...
				<div class="col-9">
					<form action="${pageContext.request.contextPath}/updateNoticeController" method="post">
						<table class="table text-align:center">
							...
							<tr>
								<th>번호</th>
								<td><input type="text" name="noticeId" readonly="readonly" value="${updateContent.noticeId}"></td>
								
							</tr>
							<tr>
								<th>제목</th>
								<td><input type="text" name="noticeTitle" value="${updateContent.noticeTitle}"></td>
							</tr>
							<tr>
								<th>내용</th>
								<td><input type="text" name="noticeContent" value="${updateContent.noticeContent}"></td>
							</tr>
							<tr>
								<th>작성날짜</th>
								<td>${updateContent.createDate}</td>
							</tr>
							<tr>
								<th>수정날짜</th>
								<td>${updateContent.updateDate}</td>
							</tr>
							
							
						</table>
						<button type="submit" class="site-btn float-right" >수정</button>
					</form>
				</div>
			</div>
		</div>
